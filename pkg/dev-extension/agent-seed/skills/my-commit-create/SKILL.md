...
**First, before you stage anything: run `my-code-comment-refinement`** and finish it. It lists every comment the change adds and removes the ones that do not document a public interface, so none reach the commit. Then:
